...
class Laser(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load("C:/Users/edgar/OneDrive/Escritorio/platanochikito.png").convert()
...
class Meteor(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load('C:/Users/edgar/OneDrive/Escritorio/mascarita.png').convert()
        self.image.set_colorkey(negro)
        self.rect = self.image.get_rect()
...
class Player(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load('C:/Users/edgar/OneDrive/Escritorio/kemonito.png').convert()
        self.image.set_colorkey(negro)
        self.rect = self.image.get_rect()
...
def main():
    ...
    fondo = pygame.image.load('C:/Users/edgar/OneDrive/Escritorio/RingSolo.jpg')
    ...
    sound = pygame.mixer.Sound('C:/Users/edgar/OneDrive/Escritorio/bonk2.mp3')
    #pygame.mixer.music.load('C:/Users/edgar/OneDrive/Escritorio/luchadores2.mp3')
    #pygame.mixer.music.play(1)
